...
- [x] **Step 1: Добавить секцию в SKILL.md**
...
- [x] **Step 2: Проверить, что секция на месте и уникальна**
...
- [x] **Step 1: Дописать строку синхронизации в конец каждого файла**
...
- [x] **Step 2: Проверить, что все 11 файлов получили ровно одну ссылку**
...
- [x] **Step 1: Добавить блок BFT-жизненного цикла**
...
- [x] **Step 1: Добавить блок простановки статусов**
...
- [x] **Step 2: Синтаксис-чек**

Run: `bash -n install.sh && echo "syntax OK"`
Expected: `syntax OK`

- [x] **Step 3: Проверить sed-преобразование на копии конфига (реальный прогон)**
...
- [x] **Step 4: Проверить идемпотентность (второй прогон не дублирует)**
...
- [x] **Step 1: Прогнать жизненный цикл BFT на временной доске**
...
- [x] **Step 2: Финальный self-check плана против спеки**
