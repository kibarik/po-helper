...
|---|---|---|---|
| Цифровизация контекста → насыщенный Нексус (low-CP) перед Steps 1–8 | ✅ **`/paf-onboard` построен** (`.claude/skills/paf-onboard/SKILL.md`, Phase A/B/C/D по spec §5) | — | spec §5 · scope §11.5 |
