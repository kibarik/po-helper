...
| Стек | **Claude Code обязателен**; **Excalidraw MCP обязателен (MustHave)** — визуализация/согласование карт, диаграмм, борд через Excalidraw-доски; Obsidian рекомендован; ruflo MCP опционален (graceful degradation). |
