...
kr: ["<KR-код>", "..."]        # плейсхолдер обязательно в кавычках: kr: ["[KR?] описание"]
теги: [daily-review]
---
...
- **Frontmatter-YAML:** значения с плейсхолдерами в квадратных скобках (`[KR?]`, `[УТОЧНИТЬ]`, `[КОД?]`) обязательно заключать в кавычки (`kr: ["[KR?] ..."]`, `sprint: "[УТОЧНИТЬ]"`) — иначе `[...]` парсится как YAML-список и ломает frontmatter.
