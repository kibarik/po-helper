...
<Рамка всего документа (ЗМ-006): диалог с продактом в плоскости метрики, а не хотелок. Метрика верификации — единственная. Гипотеза/метрика/МДО — To-Be, якорь R2/R3 (не код).>
