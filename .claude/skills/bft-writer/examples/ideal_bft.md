...
Канонический порядок теперь: Оглавление → О задаче (1.1 As-Is→Gap→To-Be / 1.2 Контекст обращения / 1.3 Стейкхолдеры)
→ План демо для стейкхолдера → Критерии успеха (3.0 scope-exclusions / 3.1–3.5 БТ-НФТ) → Риски и зависимости → Открытые вопросы.
