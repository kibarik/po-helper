...
Диагностика: ASIS (с якорями: JIRA/Confluence/код/CORTEX-СА) → ПРОБЛЕМА (бизнес-разрыв) → TOBE в требованиях. В БФТ — раздел «Проблема которую решаем» (таблица ASIS/ПРОБЛЕМА/TOBE).
