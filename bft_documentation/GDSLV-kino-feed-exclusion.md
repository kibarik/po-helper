...
| Роль | Кто | Интерес |
| --- | --- | --- |
| Заказчик / приёмка | Стейкхолдер бизнеса | Кино не попадает в платную рекламу; знает причину запрета |
| Исполнитель (extapi) | Команда extapi | Ведёт рекламные фиды, вносит фильтр на генерации |
| Постановщик | PO | Формулирует требование и критерии приёмки |
...
| Актор | Роль на демо |
| --- | --- |
| Стейкхолдер | Принимает результат, задаёт критерий достаточности |
