...
Плюс **вложение** — сводная таблица требований (БТ/ПТ/ИТ/ФТ/НФТ) на согласование границ: каждая строка ← цитата участника встречи, без обогащения (пороги/приоритеты/детализация — на этапе глубокой проработки).
